...
START_TEST(s21_ceil_f) {
  ...
  double value6 = 0.0 / 0.0;
  ck_assert_uint_eq(s21_ceil(value6), ceil(value6));
}
END_TEST
...
START_TEST(s21_pow_f) {
  ck_assert_int_eq(s21_pow(1, 0), pow(1, 0));
  ck_assert_int_eq(s21_pow(1, 1), pow(1, 1));
  ...
  ck_assert_int_eq(s21_pow(-s21_INF, -1), pow(-s21_INF, -1));
  ck_assert_int_eq(s21_pow(-s21_INF, 2), pow(-s21_INF, 2));
  ck_assert_int_eq(s21_pow(s21_INF, -666), pow(s21_INF, -666));
  ck_assert_int_eq(s21_pow(s21_INF, 666), pow(s21_INF, 666));
  ck_assert_int_eq(s21_pow(0, -1), pow(0, -1));
  ck_assert_int_eq(s21_pow(0, 1), pow(0, 1));
  ck_assert_int_eq(s21_pow(0, 0), pow(0, 0));
  ck_assert_int_eq(s21_pow(2, s21_INF), pow(2, s21_INF));
